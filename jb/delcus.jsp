...
/* 		out.flush(); */
		...
		try {
			for(int i = 0;i<data.size();i++){
				//회원테이블에서 삭제.
				String strSQL = "delete from people where id = '"+data.get(i)+"'";
				stm.executeUpdate(strSQL);
				//취향테이블에서 삭제.
				strSQL = "delete from likedb where id = '"+data.get(i)+"'";
				stm.executeUpdate(strSQL);
			}
			%>
...
/* 		document.getElementById('load').style.visibility = "hidden"; */
		alert("회원 삭제에 성공했습니다.");
		location.replace('i_admincus.jsp');
	</script>
	<%
